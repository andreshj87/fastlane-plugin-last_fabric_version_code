...
require 'fastlane/plugin/last_fabric_version_code/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-last_fabric_version_code'
  spec.version       = Fastlane::LastFabricVersionCode::VERSION
  spec.author        = 'Andrés Hernández'
